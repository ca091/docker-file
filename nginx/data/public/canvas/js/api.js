function init(){
	...
	var lg = ctx.createLinearGradient(0,0,canvas.width,canvas.height);
	...
	//设置笔触 --> stroke绘制
	var lineWidth = 10 ,strokeStyle = 'orange',lineCap = 'round', lineJoin='bevel';
	var fillStyle = '#dd4814';
	ctx.beginPath();
	...
	ctx.beginPath();
	//迳向渐变填充
	var rg = ctx.createRadialGradient(650,110,1,600,110,200);
